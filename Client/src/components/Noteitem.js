...
export default function Noteitem(props) {
    ...
    const { updateNote, setcreateNote, setupdate, render,  setexpandNoteBox,notes,StarNotes } = context
    const { title, desc, tag, edited, date, stared,color, id, num, setconfirmAlert,newNote } = props
    ...
    let markedStar = async (event) => {
        ...
        setstar(s)
        updateNote(id, title, desc, tag, edited, date, s,titleColor)
    }
let changingColor=(color)=>{
    setTitleColor(color)
    updateNote(id, title, desc, tag, edited, date, star,color)
}
    return (
